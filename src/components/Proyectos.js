...
import gymbroszone from '../resources/gymbroszone.png';
                ...
                <div className='proyectos'>
                    <div className='proyecto'>
                        <div className='todo_descripcion'>
                            ...
                            <div className='parrafo_proyecto parrafo1'>
                                GymBros Zone es una red social innovadora enfocada en el mundo del gimnasio y fitness, creada para conectar a entusiastas del ejercicio y promover un estilo de vida saludable.
                            </div>
                            <div className='parrafo_proyecto parrafo2'>
                                En GymBros Zone, los usuarios pueden compartir experiencias, intercambiar conocimientos y alcanzar sus metas.
                            </div>
                            <div className='botones_proyecto'>
                                <a href="https://gymbroszone.com" target="blank">
                                ...
                                <a href="https://github.com/rauldomrob/gymbroszone" target="blank" className='boton_margen'>
                        ...
                        <div className='todo_img_proyecto'>
                            <div className='img_proyecto'>
                                <a href="https://gymbroszone.com" target="blank">
                                    <img src={gymbroszone} alt="gymbroszone"></img>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='proyecto proyecto_reves'>
                        ...
                        <div className='todo_img_proyecto'>
                            <div className='img_proyecto'>
                                <a href="https://github.com/rauldomrob/DevCode" target="blank">
                                    <img src={devcode} alt="devcode"></img>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='proyecto'>
                        ...
                        <div className='todo_img_proyecto'>
                            <div className='img_proyecto'>
                                <a href="https://petpalace-raul-dominguez-robles.pages.dev" target="blank">
                                    <img src={petpalace} alt="petpalace"></img>
                                </a>
                            </div>
                        </div>
                    </div>
